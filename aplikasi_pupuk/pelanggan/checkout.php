...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['action']) && $_POST['action'] == 'place_order') {
    ...
    $metode_pembayaran = $_POST['metode_pembayaran'] ?? ''; // <--- BARIS TAMBAHAN
    ...
    if (empty($alamat_pengiriman)) {
        ...
        $message_type = "error";
    } elseif (empty($metode_pembayaran)) { // <--- VALIDASI TAMBAHAN
        ...
        try {
            ...
            if ($stock_issues) {
                ...
                $status_pembayaran_awal = 'pending_pembayaran'; // <--- BARIS TAMBAHAN

                // <--- QUERY INSERT YANG SUDAH DIMODIFIKASI --- >
                $stmt_pesanan = $conn->prepare("INSERT INTO pesanan (id_pelanggan, alamat_pengiriman, catatan, total_harga, status_pesanan, status_pembayaran, metode_pembayaran) VALUES (?, ?, ?, ?, ?, ?, ?)");
                // <--- BIND_PARAM YANG SUDAH DIMODIFIKASI --- >
                $stmt_pesanan->bind_param("isdssss", $user_id, $alamat_pengiriman, $catatan, $total_harga_keranjang, $status_pesanan, $status_pembayaran_awal, $metode_pembayaran);
                ...
                header("Location:  payment_confirmation.php?pesanan_id=" . $pesanan_id);
                exit;
            }
        ...
        <div class="checkout-card">
            ...
            <?php else: ?>
                ...
                <div class="shipping-address">
                    <h3><i class="fas fa-map-marked-alt"></i> Detail Pengiriman & Pembayaran</h3>
                    ...
                    <form action="checkout.php" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="catatan" name="catatan" rows="2" placeholder="Contoh: 'Letakkan di teras rumah.'"><?php echo htmlspecialchars($_POST['catatan'] ?? ''); ?></textarea>
                             <small>Contoh: "Letakkan di samping gudang belakang."</small>
                        </div>
                        <div class="form-group">
                            ...
                            <select id="metode_pembayaran" name="metode_pembayaran" required>
                                ...
                                <option value="Cash on Delivery (COD)" <?php echo (isset($_POST['metode_pembayaran']) && $_POST['metode_pembayaran'] == 'Cash on Delivery (COD)') ? 'selected' : ''; ?>>Cash on Delivery (COD)</option>
                            </select>
                        </div>
                        <!-- AKHIR KODE YANG DIMASUKKAN -->
